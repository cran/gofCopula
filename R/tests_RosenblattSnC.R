...
#' 
#' \code{\link{gofRosenblattSnC}} contains the SnC gof test from Genest (2009)
...
#' 
#' @export gofRosenblattSnC
gofRosenblattSnC <- function(copula = c("normal", "t", "clayton", "gumbel", 
